...
var myDate = new Date();
var getLocalDate = (date, isSeconds = false, isIso = false) => {
...
console.log(getWeekDay('2020-07-15')); // среда
console.log(getWeekDay('2020-07-14')); // вторник
console.log(getWeekDay('2020-07-25')); // суббота
...
console.log(getLocalDay('2020-07-14')); // 2
console.log(getLocalDay('2020-07-16')); // 4
console.log(getLocalDay('2020-07-18')); // 6
